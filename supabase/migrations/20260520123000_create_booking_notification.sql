...
begin
  ...
  select c.price_per_hour, c.name, v.name
  into v_court_price, v_court_name, v_venue_name
  ...
  values (
    ...
    concat(
      ...
      ' - ',
      coalesce(v_court_name, 'court'),
      ' berhasil dibuat. Selesaikan pembayaran agar jadwalmu dikonfirmasi.'
    )
  );
