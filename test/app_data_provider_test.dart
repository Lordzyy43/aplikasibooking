...
void main() {
  test(
    'app data provider loads seeded content and accepts new bookings',
    () async {
      final provider = AppDataProvider(useSeedData: true);
      ...
      expect(provider.notifications.first.title, 'Booking Berhasil!');
    },
  );
}
